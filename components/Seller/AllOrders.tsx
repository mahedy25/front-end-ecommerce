...
export default function AllOrders() {
  ...
  return (
    <div className='max-w-6xl mx-auto md:p-4 space-y-10'>
      <h1 className='text-3xl font-extrabold text-[#046C4E] mb-8'>
        All Orders
      </h1>
        ...
        orders.map((order) => (
          ...
          >
            <div className='flex flex-col md:flex-row md:justify-between md:items-center'>
              <div>
                <h2 className='text-xl font-bold text-[#046C4E]'>
                  Order #{order.id}
                </h2>
            ...
            <div className='grid   gap-4'>
              {order.items.map((item) => (
                <div
                  key={item.id}
                  className='flex flex-col md:flex-row items-center flex-shring-0 gap-4 border border-gray-200 p-3 rounded-lg hover:shadow-sm'
                >
                  ...
                  <div className='flex flex-col justify-center'>
                    <p className='font-medium text-[#046C4E] text-sm'>
                      {item.title}
                    </p>
                    ...
                    <p className='text-xs text-gray-500'>
                      Price: ${item.offerPrice.toFixed(2)}
                    </p>
                  </div>
                </div>
              ))}
